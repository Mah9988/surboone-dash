...
// ** Reactstrap Imports
import { Button, Label, FormText, Form, Input, Card, CardBody } from 'reactstrap'
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    {/* <div className='mb-1'>
                        ...
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <InputPasswordToggle type='password' className='input-group-merge' id='password' invalid={errors.password && true} {...field} />
                            )}
                        />
                    </div> */}
                    <div className='mb-1'>
