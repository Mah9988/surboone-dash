...
// ** Reactstrap Imports
import { Card, CardHeader, CardTitle, CardBody, Button, ListGroup, ListGroupItem, Label, Input, Row, Col } from 'reactstrap'
...
const index = () => {
    ...
    return (
        <Card>
            ...
            <CardBody>
                <div {...getRootProps({ className: skin === 'dark' ? 'dropzone dark' : 'dropzone' })}>
                    <input {...getInputProps()} />
                ...
                <Row>
                    <Col md={6}>
                        ...
                        <div className='mb-1 mt-1'>
                            ...
                            <Input id='username' placeholder='johnDoe99' />
                        </div>
                    </Col>
                    <Col md={6}>
                        ...
                        <div className='mb-1 mt-1'>
                            <Label className='form-label' for='username'>
                                Image Alt <span className='text-danger'>*</span>
                            </Label>
                            <Input id='username' placeholder='johnDoe99' />
                        </div>
                    </Col>
